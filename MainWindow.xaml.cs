...
namespace Game
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            _horses = new Horse[5] 
            { 
                new Horse("Silver", Brushes.DeepSkyBlue), 
                new Horse("Sparkle", Brushes.MediumPurple), 
                new Horse("Moon", Brushes.Navy), 
                new Horse("Whisper", Brushes.LightPink),
                new Horse("Shadow", Brushes.Firebrick)
            };
        ...
        {
            path = $@"C:\Users\victo\OneDrive\Документы\my\2-ий курс\OOP\семестр 2\lab3\Horse_Racing\{path}\{name}";
